...
function ResetPasswordForm() {
  ...
  const handleSendCode = async () => {
    try {
      ...
      const response = await fetch('https://auth-2y2nerf26-aakartits-projects.vercel.app/users/send-reset-code', {
        method: 'POST',
        headers: {
  ...
  const handleVerifyCode = async () => {
    try {
      ...
      const response = await fetch('https://auth-2y2nerf26-aakartits-projects.vercel.app/users/verify-reset-code', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  console.log(resetCode)
    try {
      ...
      const response = await fetch('https://auth-2y2nerf26-aakartits-projects.vercel.app/users/reset-password', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
